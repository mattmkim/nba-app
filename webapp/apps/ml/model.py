...
x_train, x_test, y_train, y_test = train_test_split(modern_stats, modern_stats["AllNBA"], train_size=0.8, test_size=0.2)

x_train = x_train.drop(["Unnamed: 0", "Year", "Player", "Pos", "Age", "Tm", "G", "GS", "MP", "Identifier", "AllNBA", 'PER', 'TS%', '3PAr', 'FTr', 'ORB%', 'DRB%', 'TRB%', 'AST%', 'STL%', 'BLK%', 'TOV%', 'USG%', 'OWS', 'DWS',
            'WS', 'WS/48', 'OBPM', 'DBPM', 'BPM', 'VORP', 'FG', 'FGA', '3PA', '2P', '2PA', '2P%',
            'eFG%', 'FTA', 'FT%', 'ORB', 'DRB', 'TRB'], axis=1)
x_test = x_test.drop(["Unnamed: 0", "Year", "Player", "Pos", "Age", "Tm", "G", "GS", "MP", "Identifier", "AllNBA", 'PER', 'TS%', '3PAr', 'FTr', 'ORB%', 'DRB%', 'TRB%', 'AST%', 'STL%', 'BLK%', 'TOV%', 'USG%', 'OWS', 'DWS',
            'WS', 'WS/48', 'OBPM', 'DBPM', 'BPM', 'VORP', 'FG', 'FGA', '3PA', '2P', '2PA', '2P%',
            'eFG%', 'FTA', 'FT%', 'ORB', 'DRB', 'TRB'], axis=1).values

# training = modern_stats[modern_stats["Year"] < 2016]
# test = modern_stats[modern_stats["Year"] >= 2016]
#
